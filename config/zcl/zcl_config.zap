  ...
  "endpointTypes": [
    {
      ...
      "clusters": [
        ...
        },
        {
          ...
          "code": 64172,
          "mfgCode": null,
          "define": "THERMOSTAT_SETTINGS_CLUSTER",
          "side": "server",
          "enabled": 1,
          "commands": [
            {
          ...
          "attributes": [
            ...
            {
              "name": "automatic dimming timeout in seconds",
              "code": 6,
              "mfgCode": null,
              "side": "server",
              "type": "int16u",
